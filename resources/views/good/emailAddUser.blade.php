		...
		<div class="regist">
			<div class="regist_center">
				<div class="regist_top">
					...
					<div class="right fr"><a href="{{url('homepage/mobileAdd')}}">手机号注册&nbsp;&nbsp;&nbsp;</a></div>
					<div class="clear"></div>
				...
				<div class="regist_main center">
					...
					<div class="username">邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;箱:&nbsp;&nbsp;<input class="shurukuang" type="text" name="user_email" placeholder="请填写正确的邮箱地址"/><span>@if(is_object($errors)){{$errors -> first('user_email')}}@endif</span></div>
					<div class="username">
