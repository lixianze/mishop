...
<html>
	...
	<body>
		...
		<form  method="post" action="/index.php/emailLoginUser" class="form center">
		@csrf
		<div class="login">
			<div class="login_center">
				<div class="login_top">
					...
					<div class="right fr"><a href="{{url('homepage/mobileLogin')}}" target="_self">手机号登陆&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></div>
					<div class="clear"></div>
					<div class="xian center"></div>
				</div>
				<div class="login_main center">
					<div class="username">邮箱地址:<input class="shurukuang" type="text" name="user_email" placeholder="请输入你的邮箱地址"/><span>@if(is_object($errors)){{$errors -> first('user_email')}}@endif</span></div>
